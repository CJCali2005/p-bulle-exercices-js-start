...
let [ premierwagon , deuxiemewagon , ...resteDesWagons ] = ids

return [ ...resteDesWagons, premierwagon , deuxiemewagon ] ;
}
...
let [ premierwagon , ...resteDesWagons ] = ids;

return [ premierwagon, ...missingWagons , ...resteDesWagons ];
}
...
export function separateTimeOfArrival(information) {
  let {timeOfArrival , ...restDesInfos} = information ;

  return [timeOfArrival,{...restDesInfos}];
}
